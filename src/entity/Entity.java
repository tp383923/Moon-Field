...
public class Entity {
	...
	public Rectangle attackArea = new Rectangle(0, 0, 0, 0); // will be overidden
	...
	public final int type_ash_glove = 4;
	public final int type_shield = 5;
	public final int type_moon_shield = 6;
	public final int type_consumable = 7; 
	public final int type_pickup_only = 8;
	public final int type_socks = 9;
	public final int type_obstacle = 10;
	public final int type_light = 11;
	public final int type_boxing_glove = 12;
	public final int type_ravaged_shield = 13;
	...
	public void setAction() {} // Subclass methods take priority
	...
	public void dropItem(Entity droppedItem) {
		for (int i = 0; i < gp.obj[1].length; i ++) {
			if (gp.obj[gp.currentMap][i] == null) {
				...
				gp.obj[gp.currentMap][i].worldX = worldX; // World X and Y of dead monster
	...
	public void generateParticle(Entity generator, Entity target) {
		...
		Particle pl = new Particle(gp, target, color, size, speed, maxLife, -2, -1); // Horizontal vectors are increased
	...
	public void attacking() {
		...
		if (spriteCounter > motion1_duration && spriteCounter <= motion2_duration) {
			...
			// Adjust the player's coordinates for attackArea
			switch(direction) {
			...
			if (type == type_monster) {
				if (gp.eChecker.checkPlayer(this)) {
					damagePlayer(attack);
				}
			} else { // PLAYER
				// Check monster collision with updated coordinates
				...
				int projectileIndex = gp.eChecker.checkEntity(this, gp.projectile);
